...
class MakeTenantModule extends BaseModule
{
    ...
    {
        $stub = File::get(app_path('Console/Commands/stubs/model_tenant.stub'));
        return str_replace(
            ['{{MODULE}}', '{{TYPE}}'],
            [$name, 'Tenant'],
            $stub
